...
#import "NSString+URLEscapingAdditions.m"

@implementation BMYURLRequestParameter
...
+ (NSArray *)parametersFromString:(NSString *)inString
{
    ...
    NSString *name = nil;
    NSString *value = nil;
    BMYURLRequestParameter *currentParameter = nil;
    ...
    while(![parameterScanner isAtEnd]){
        ...
        currentParameter = [[BMYURLRequestParameter alloc] init];
...
+ (NSArray *)parametersFromDictionary:(NSDictionary *)inDictionary
{
    ...
    BMYURLRequestParameter *aURLParameter = nil;
    for(NSString *aKey in [inDictionary allKeys]){
        aURLParameter = [[BMYURLRequestParameter alloc] init];
...
+ (NSString *)parameterStringForParameters:(NSArray *)inParameters
{
    ...
    BMYURLRequestParameter *aParameter = nil;
...
{
    NSComparisonResult result = [self.name compare:[(BMYURLRequestParameter *)inObject name]];
    if(result == NSOrderedSame){
        result = [self.value compare:[(BMYURLRequestParameter *)inObject value]];
    }
    return result;
}
